...
import com.watchingTVmobile.watchingTV.database.DatabaseHelper;
...
public class Favoris {
    ...
    public static List<FilmDescrip> getFavMovieBriefs(Context context) {
        DatabaseHelper databaseHelper = new DatabaseHelper(context);
        SQLiteDatabase database = databaseHelper.getReadableDatabase();

        List<FilmDescrip> favMovies = new ArrayList<>();
        ...
        while (cursor.moveToNext()) {
            ...
            favMovies.add(new FilmDescrip(null, movieId, null, null, name, null, posterPath, null, null, null, null, null, null, null));
        }
        cursor.close();
        database.close();
        return favMovies;
    ...
    public static List<SerieDescrip> getFavTVShowBriefs(Context context) {
        DatabaseHelper databaseHelper = new DatabaseHelper(context);
        SQLiteDatabase database = databaseHelper.getReadableDatabase();

        List<SerieDescrip> favTVShows = new ArrayList<>();
        ...
        while (cursor.moveToNext()) {
            ...
            String posterPath = cursor.getString(cursor.getColumnIndex(DatabaseHelper.POSTER_PATH));
            String name = cursor.getString(cursor.getColumnIndex(DatabaseHelper.NAME));
            favTVShows.add(new SerieDescrip(null, tvShowId, name, null, null, posterPath, null, null, null, null, null, null, null));
        }
        cursor.close();
        database.close();
        return favTVShows;
