...
public class SerieDescripSmallAdapter extends RecyclerView.Adapter<SerieDescripSmallAdapter.TVShowViewHolder> {

    private Context mContext;
    private List<SerieDescrip> mTVShows;

    public SerieDescripSmallAdapter(Context context, List<SerieDescrip> tvShows) {
        mContext = context;
        mTVShows = tvShows;
    }
    ...
    public void onBindViewHolder(TVShowViewHolder holder, int position) {
        ...
        if (Favoris.isTVShowFav(mContext, mTVShows.get(position).getId())) {
        ...
        public TVShowViewHolder(View itemView) {
            ...
            tvShowFavImageButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Favoris.addTVShowToFav(mContext, mTVShows.get(getAdapterPosition()).getId(), mTVShows.get(getAdapterPosition()).getPosterPath(), mTVShows.get(getAdapterPosition()).getName());
